...
public class Dip {
    ...
    final static int rangeNumbers = 49;
    final static int rangeStars = 9;
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < maxNumbers; ) {
            int candidate = generator.nextInt(rangeNumbers) + 1;
        ...
        for (int i = 0; i < maxStars; ) {
            int candidate = generator.nextInt(rangeStars) + 1;
